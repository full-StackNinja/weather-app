...
searchBtn.addEventListener("click", async () => {
  ...
  _weatherApi__WEBPACK_IMPORTED_MODULE_2__["default"]
    .loadData()
    .then(() => {
      ...
      // Get fetched data
      const dataToDisplay = _weatherApi__WEBPACK_IMPORTED_MODULE_2__["default"].getData();
    ...
    .catch((error) => {
      _domManipulation__WEBPACK_IMPORTED_MODULE_1__["default"].displayError(error);
    });
});
