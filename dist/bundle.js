...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,mJAAmJ;AACrJ;AACA;EACE,SAAS;AACX;;AAEA;EACE,WAAW;AACb","sourcesContent":["* {\n  font-family: system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Open Sans\", \"Helvetica Neue\", sans-serif;\n}\nhtml {\n  font: 1px;\n}\n\nbody {\n  font: 16rem;\n}\n"],"sourceRoot":""}]);
// Exports
...
const data = await _weatherApi__WEBPACK_IMPORTED_MODULE_2__["default"].loadData("London");
console.log(data);
